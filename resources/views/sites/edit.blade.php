...
<head>
    ...
    <title>Edit Site - {{ $site->name }}</title>
...
<body class="bg-gray-100">
            ...
            <div class="bg-white shadow-md rounded-lg p-6">
                ...
                <form action="{{ route('sites.update', $site) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="url" name="url" id="url" value="{{ old('url', $site->url) }}"
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        @error('url')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="check_interval" id="check_interval" value="{{ old('check_interval', $site->check_interval) }}"
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="url" name="webhook_url" id="webhook_url" value="{{ old('webhook_url', $site->webhook_url) }}"
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        @error('webhook_url')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <!-- Logs Per Page Field -->
                    <div class="mb-4" id="logsPerPageField" style="{{ !$site->enable_logging ? 'display: none;' : '' }}">
                        <label for="logs_per_page" class="block text-sm font-medium text-gray-700">Logs Per Page</label>
                        <input type="number" name="logs_per_page" id="logs_per_page" value="{{ old('logs_per_page', $site->logs_per_page) }}"
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        @error('logs_per_page')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="cooling_time" id="cooling_time" value="{{ old('cooling_time', $site->cooling_time) }}"
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="max_retries" id="max_retries" value="{{ old('max_retries', $site->max_retries) }}"
                               min="1" max="10"
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div class="mb-4">
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            When inactive, monitoring will be paused for this site.
                        </p>
                    </div>
    ...
    <script>
        ...
        document.querySelector('input[name="enable_logging"]').addEventListener('change', function() {
